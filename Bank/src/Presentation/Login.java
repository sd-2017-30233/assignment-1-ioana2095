    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       Logare l=new Logare();
            if(l.logareEmployee(username,password)!=null){
                ...
                data1.setType(str[1]);
                data1.setId_Employee(Integer.parseInt(str[0]));
                frame=new BankOperation();
                frame.setVisible(true);
                this.setVisible(false);
                
            }
            else{
                JOptionPane.showMessageDialog(this, "Angajatul nu exista sau parola/username gresit");
                jTextField2.setText("");
